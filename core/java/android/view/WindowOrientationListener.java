    ...
    class SensorEventListenerImpl implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if ((zyangle <= PIVOT_UPPER) && (zyangle >= PIVOT_LOWER)) {
                ...
                // If you are in the 2nd or 4th quadrant we should re-orient to
                ...
                // If the sensor does not help, figure out which way it should be.
                if (mSensorRotation == -1) {
                    ...
                    newRotation = (orientation <= LP_LOWER);
                } else {
                    newRotation = (orientation >= PL_UPPER);
                }

                if (landscape ^ newRotation) {
